...
_STAGE_SPECS = Registry({
    "HRNET-W40-FPN": hrnet_w40,
    "HRNET-W18-FPN": hrnet_w18,
    "HRNET-W32-FPN": hrnet_w32,
    "HRNET-W40-LIBRA": hrnet_w40,
    "HRNET-W18-LIBRA": hrnet_w18,
    "HRNET-W32-LIBRA": hrnet_w32,
})
...
class HighResolutionModule(nn.Module):
    ...
    def _check_branches(self, num_branches, blocks, num_blocks, num_inchannels, num_channels):
        assert(num_branches == len(num_blocks)), "num branches != num_blocks"
        assert(num_branches == len(num_channels)), "num_branches != num_channels"
        assert(num_branches == len(num_inchannels)), "num_branches != num_inchannels"
...
class HRNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # stage 1
        self.stage1_cfg = stage_specs["STAGE1"]
        ...
        # stage 2
        self.stage2_cfg = stage_specs["STAGE2"]
        ...
        # stage 3
        self.stage3_cfg = stage_specs["STAGE3"]
        ...
        # stage 4
        self.stage4_cfg = stage_specs["STAGE4"]
