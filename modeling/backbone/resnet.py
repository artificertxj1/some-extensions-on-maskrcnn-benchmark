...
from ModelCore.layers import FrozenBatchNorm2d
from ModelCore.layers import Conv2d
from ModelCore.layers import DFConv2d
from ModelCore.layers import GlobalContextBlock
from ModelCore.layers import CBAM
...
class ResNet(nn.Module):
    def __init__(self, cfg):
        ...
        for stage_spec in stage_specs:
            ...
            ## specify global context block
            stage_with_gcb = cfg.MODEL.RESNETS.STAGE_WITH_GCB[stage_spec.index - 1]

            ## specify cbam block
            stage_with_cbam = cfg.MODEL.RESNETS.STAGE_WITH_CBAM[stage_spec.index - 1]
            ...
            module = _make_stage(
                ...
                gcb_config={
                    ...
                    "ratio": cfg.MODEL.RESNETS.GCB_RATIO,
                    "pooling_type": cfg.MODEL.RESNETS.GCB_POOLING_TYPE,
                    "fusion_types": cfg.MODEL.RESNETS.GCB_FUSION_TYPES,
                },
                cbam_config={
                    "stage_with_cbam": stage_with_cbam,
                    "reduction_ratio": cfg.MODEL.RESNETS.CBAM_REDUCTION_RATIO,
                    "pool_types": cfg.MODEL.RESNETS.CBAM_POOL_TYPES,
                    "no_spatial": cfg.MODEL.RESNETS.CBAM_NO_SPATIAL,
                }
            )
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.with_gcb:
            #print("using global context block")
...
_STAGE_SPECS = Registry({
    ...
    "R-50-LIBRA": ResNet50FPNStagesTo5,
    "R-101-LIBRA": ResNet101FPNStagesTo5,
    "R-152-LIBRA": ResNet152FPNStagesTo5,
})