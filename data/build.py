...
from ModelCore.utils.comm import  get_world_size
from ModelCore.utils.imports import import_file
from ModelCore.utils.miscellaneous import save_labels
...
#def build_dataset(dataset_list, transforms, dataset_catalog, cfg, is_train=True):
    ...
    for dataset_name in dataset_list:
        ...
        if data["factory"] == "COCODataset":
            ...
            #args["remove_images_without_annotations"] = cfg.INPUT.REMOVE_IAMGES_WITHOUT_ANNOTATIONS
        #if data["factory"] == "tctDataset":
        #    args["remove_images_without_annotations"] = cfg.INPUT.REMOVE_IAMGES_WITHOUT_ANNOTATIONS
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False):
    ...
    #datasets = build_dataset(dataset_list, transforms, DatasetCatalog, cfg, is_train or is_for_period)
    if is_train:
